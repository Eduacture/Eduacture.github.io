                        ...
                        <div class="shop-items text-center">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="item">
                                        <div class="item-image">
                                            <img src="images/shop/4.jpg" alt="Item Image" class="radius">
                                            <div class="item-hover">
                                                <a href="shop-single.php" class="btn">View details</a>
                                                <div class="rating">
                                                    <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="item">
                                        <div class="item-image">
                                            <img src="images/shop/5.jpg" alt="Item Image" class="radius">
                                            <div class="item-hover">
                                                <a href="shop-single.php" class="btn">View details</a>
                                                <div class="rating">
                                                    <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="item">
                                        <div class="item-image">
                                            <img src="images/shop/6.jpg" alt="Item Image" class="radius">
                                            <div class="item-hover">
                                                <a href="shop-single.php" class="btn">View details</a>
                                                <div class="rating">
                                                    <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="item">
                                        <div class="item-image">
                                            <img src="images/shop/7.jpg" alt="Item Image" class="radius">
                                            <div class="item-hover">
                                                <a href="shop-single.php" class="btn">View details</a>
                                                <div class="rating">
                                                    <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="item">
                                        <div class="item-image">
                                            <img src="images/shop/8.jpg" alt="Item Image" class="radius">
                                            <div class="item-hover">
                                                <a href="shop-single.php" class="btn">View details</a>
                                                <div class="rating">
                                                    <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="item">
                                        <div class="item-image">
                                            <img src="images/shop/9.jpg" alt="Item Image" class="radius">
                                            <div class="item-hover">
                                                <a href="shop-single.php" class="btn">View details</a>
                                                <div class="rating">
                                                    <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
