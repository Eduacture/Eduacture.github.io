...
<head>
    ...
    <title>Educature- All Instructors</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/1.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Johnny Kennedy</a></h3>
                                <!-- /.name -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/2.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Kathleen Ortiz</a></h3>
                                <!-- /.name -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/3.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Louis Fox</a></h3>
                                <!-- /.name -->
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/4.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Lauren Day </a></h3>
                                <!-- /.name -->
                                <span class="designation">Web Designer</span>
                                <!-- /.designation -->
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/5.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.phpl">Anna Beck</a></h3>
                                <!-- /.name -->
                                <span class="designation">Developer</span>
                                <!-- /.designation -->
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/6.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Ruth Castro</a></h3>
                                <!-- /.name -->
                                <span class="designation">UI Designer</span>
                                <!-- /.designation -->
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/7.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Harold Wagner</a></h3>
                                <!-- /.name -->
                                <span class="designation">Web Designer</span>
                                <!-- /.designation -->
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="instructor">
                            <div class="avatar radius">
                                <a href="instructor-details.php"><img src="images/speakers/8.jpg" alt="Avatar Image"></a>
                            </div>
                            <!-- /.avatar -->
                            <div class="instructor-details">
                                <h3 class="name"><a href="instructor-details.php">Samuel Torres</a></h3>
                                <!-- /.name -->
                                <span class="designation">Developer</span>
                                <!-- /.designation -->
                            </div>
