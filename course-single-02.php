    ...
    <section class="courses">
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h2 class="course-title">Photoshop for Web Design Beginners</h2>
                        <!-- /.course-title -->
                        ...
                        <div class="course-single-details">
                            ...
                            <p>
                                ...
                                were workshy. And what’s more, would he have been entirely wrong in this case? Gregor did in fact, apart from excessive sleepiness after sleeping for so long, feel completely well and even felt much hungrier than usual.
                            </p>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="media">
                                                        ...
                                                        <div class="author-details media-body">
                                                            ...
                                                            <h3 class="name"><a href="#">Cheryl Burns</a></h3>
                                                            <!-- /.name -->
                                                        </div>
                                                        <!-- /.author-details -->
                                                    </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class="review-details">
                                                        <h3 class="title">Awesome Learning Site</h3>
                                                        <!-- /.title -->
                                                        <div class="rating">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="media">
                                                        ...
                                                        <div class="author-details media-body">
                                                            <span class="time">3 days ago</span>
                                                            <h3 class="name"><a href="#">Bobby Newman</a></h3>
                                                            <!-- /.name -->
                                                        </div>
                                                        <!-- /.author-details -->
                                                    </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class="review-details">
                                                        <h3 class="title">Great in-depth explanations</h3>
                                                        <!-- /.title -->
                                                        <div class="rating">
                                                            <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="5" data-fractions="5" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="media">
                                                        ...
                                                        <div class="author-details media-body">
                                                            <span class="time">3 days ago</span>
                                                            <h3 class="name"><a href="#">Philip Bell</a></h3>
                                                            <!-- /.name -->
                                                        </div>
                                                        <!-- /.author-details -->
                                                    </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class="review-details">
                                                        <h3 class="title">Really enjoyed this course</h3>
                                                        <!-- /.title -->
                                                        <div class="rating">
                                                            <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="5" data-fractions="5" />
                                                        </div>
                        ...
                        <div class="related-courses">
                            ...
                            <div class="course-items">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="item">
                                            <div class="item-thumb"><img src="images/popular/1.jpg" alt="Item Thumbnail"></div>
                                            <!-- /.item-thumb -->
                                            <div class="item-details">
                                                <h3 class="item-title"><a href="course-single-01.php">HTML5, CSS3, Bootstrap Web Design for Beginners</a></h3>
                                                <!-- /.item-title -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="item">
                                            <div class="item-thumb"><img src="images/popular/2.jpg" alt="Item Thumbnail"></div>
                                            <!-- /.item-thumb -->
                                            <div class="item-details">
                                                <h3 class="item-title"><a href="course-single-01.php">Modern JavaScript From The Beginning</a></h3>
                                                <!-- /.item-title -->
                                                <span class="instructor"><a href="#">Justin Marks</a></span>
                                                <!-- /.instructor -->
                                                <div class="details-bottom">
                                    ...
                                    <div class="col-md-4">
                                        <div class="item">
                                            <div class="item-thumb"><img src="images/popular/3.jpg" alt="Item Thumbnail"></div>
                                            <!-- /.item-thumb -->
                                            <div class="item-details">
                                                <h3 class="item-title"><a href="course-single-01.php">Learn Your Own Blockchain In JavaScript</a></h3>
                                                <!-- /.item-title -->
                                                <span class="instructor"><a href="#">Justin Marks</a></span>
                                                <!-- /.instructor -->
                                                <div class="details-bottom">
                    ...
                    <div class="col-md-4">
                        <aside class="sidebar">
                            ...
                            <div class="info">
                                <ul class="info-list">
                                    <li><span class="price"><span class="current-price">$49.00</span> <span class="previous-price">$150.00</span></span>
                                    </li>
