...
<head>
    ...
    <title>Educature-Forgot Password</title>
            ...
            <div class="container">
                <div class="contents text-center">
                    ...
                    <form class="sign-in-form" id="sign-in-form" action="#" method="post">
                        <p class="form-input">
                            <input type="text" name="forgot" id="forgot_password" class="input" value="" placeholder="Enter the Recovery Email Address" required="">
                        </p>

                        <p class="form-input">
                            <input type="submit" name="wp-submit" id="wp-submit" class="btn" value="Send a Reset Link">
                        </p>
