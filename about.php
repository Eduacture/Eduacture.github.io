...
<body>
    ...
    <section class="about-us text-center">
        <div class="section-padding">
            <div class="container">
                ...
                <p>
                    Something’sfallen down in there,said the chief clerk in the room on the left. Gregor tried to imagine whether something of the sort that had happened to him today could ever happen to the chief clerk too, you had to concede that it was possible. But as
                    if in gruff reply to this question, the chief clerk’s firm footsteps in his highly polished boots could now be heard in the adjoining room. From the room on his right, Gregor’s sister whispered to him to let him know- Gregor, the chief
                    clerk is here. Yes, I know said Gregor to himself but without daring to raise his voice loud enough for his sister to hear him.
                </p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>
                            We don’t know what to say to him. And anyway, he wants to speak to you. So please open up this door. I’m sure he’ll be good enough to forgive the untidiness of your room. Then the chief clerk called - Good morning, Mr. Samsa, he isn’t well while his father
                            continued to speak through the door. Why else would Gregor have missed a train! The lad only ever thinks about the business.
                        </p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <p>
                            He sits with us in the kitchen and just reads the paper or train timetables. His idea of relaxation is working with his fretsaw. He’s made a little frame, it only took him two or three evenings, you’ll be amazed how nice it is. It’s hanging up in his
                            room, you’ll see it as soon as Gregor opens the door. Anyway, I’m glad you’re here, we wouldn’t have been able to get Gregor to open the door by ourselves.
                        </p>
                    </div>
                </div>
                <!-- /.row -->
    ...
    <section class="facts facts-02 background-bg" data-image-src="images/ab-bg.jpg">
        <div class="overlay">
            <div class="section-padding">
                <div class="container">
                    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Raymond Herrera</a></h4>
                                <!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Aaron Palmer</a></h4>
                                <!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">John Walsh</a></h4>
                                <!-- /.name -->
                    ...
                    <div class="col-md-3">
                        <div class="member">
                            ...
                            <div class="member-details">
                                <h4 class="name"><a href="#">Joshua Kim</a></h4>
                                <!-- /.name -->
                                <span class="designation">Mentor</span>
                            </div>
                        </div>
