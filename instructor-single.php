                ...
                <div class="course-items">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb"><img src="images/popular/13.jpg" alt="Item Thumbnail"></div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">Character Art School: Complete Character Drawing</a></h3>
                                    <!-- /.item-title -->
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb"><img src="images/popular/14.jpg" alt="Item Thumbnail"></div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">The Ultimate Drawing Course - Beginner to Advanced</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb"><img src="images/popular/15.jpg" alt="Item Thumbnail"></div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">Arts Therapy - Arts Therapy For Self Healing (Part One)</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb"><img src="images/popular/16.jpg" alt="Item Thumbnail"></div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">Discover How to Draw and paint Comics</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                ...
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">How to Draw Pinups and Sexy Women</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                ...
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">Guide to Digital Sketching: Beginner to Advanced</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                ...
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">THE ART & SCIENCE OF DRAWING / BASIC SKILLS</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                ...
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="#">How to Draw and Sketch for Absolute Beginners</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="#">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
