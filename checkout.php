...
<head>
    ...
    <title>Educature-Checkout</title>
                                    ...
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <div class="woocommerce-billing-fields__field-wrapper">
                                            ...
                                            <p class="form-row form-row-wide validate-required" id="billing_first_name_field" data-priority="10">
                                                <label for="billing_first_name" class="">Card Number&nbsp;<abbr class="required" title="required">*</abbr></label><span class="woocommerce-input-wrapper"><input class="input-text " name="billing_first_name" id="billing_first_name" value="" autocomplete="given-name" type="text" placeholder="0000 0000 0000 0000" ></span></p>
                                            <p class="form-row form-row-wide validate-required" id="billing_first_name_field" data-priority="10">
                                                <label for="billing_first_name" class="">Name On Card&nbsp;<abbr class="required" title="required">*</abbr></label><span class="woocommerce-input-wrapper"><input class="input-text " name="billing_first_name" id="billing_first_name" placeholder="Enter Your Name" value="" autocomplete="given-name" type="text"></span></p>
                                            
                                            <p class="form-row form-row-first address-field validate-required validate-state woocommerce-validated" id="billing_state_field" data-priority="80" data-o_class="form-row form-row-wide address-field validate-required validate-state woocommerce-validated">
                                                <label for="billing_state" class="">Month&nbsp;<abbr class="required" title="required">*</abbr></label><span class="woocommerce-input-wrapper"><select name="billing_state" id="billing_state" class="state_select select2-hidden-accessible" autocomplete="address-level1" data-placeholder="MM" tabindex="-1" aria-hidden="true"><option value="">MM</option><option value="BD-05">01</option><option value="BD-01">02</option><option value="BD-02">02</option><option value="BD-06">04</option><option value="BD-07">05</option><option value="BD-03">06</option><option value="BD-04">07</option><option value="BD-09">08</option><option value="BD-10">09</option><option value="BD-12">10</option><option value="BD-11">11</option><option value="BD-08">12</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" aria-haspopup="true" aria-expanded="false" tabindex="0"  role="combobox"><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span>
                                                </span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                </span>
                                            </p>
                                            
                                            <p class="form-row form-row-last address-field validate-required validate-state woocommerce-validated" id="billing_state_field" data-priority="80" data-o_class="form-row form-row-wide address-field validate-required validate-state woocommerce-validated">
                                                <label for="billing_state" class="">Year&nbsp;<abbr class="required" title="required">*</abbr></label><span class="woocommerce-input-wrapper"><select name="billing_state" id="billing_state" class="state_select select2-hidden-accessible" autocomplete="address-level1" data-placeholder="YYYY" tabindex="-1" aria-hidden="true"><option value="">YYYY</option><option value="BD-05">2008</option><option value="BD-01">2009</option><option value="BD-02">2010</option><option value="BD-06">2011</option><option value="BD-07">2012</option><option value="BD-03">2013</option><option value="BD-04">2014</option><option value="BD-09">2015</option><option value="BD-10">2016</option><option value="BD-12">2017</option><option value="BD-11">2018</option><option value="BD-08">2019</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" aria-haspopup="true" aria-expanded="false" tabindex="0"  role="combobox"><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span>
                                                </span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                </span>
                                            </p>
                                            ...
                                            <p class="form-row form-row-first address-field validate-postcode" id="billing_postcode_field" data-priority="90" data-o_class="form-row form-row-wide address-field validate-postcode">
                                                <label for="billing_postcode" class="">Postcode / ZIP&nbsp;<span class="optional">(optional)</span></label><span class="woocommerce-input-wrapper"><input class="input-text " name="billing_postcode" id="billing_postcode" placeholder="Zip/PostalCode" value="" autocomplete="postal-code" type="text"></span></p>
                                            <p class="form-row form-row-last address-field validate-postcode" id="billing_postcode_field" data-priority="90" data-o_class="form-row form-row-wide address-field validate-postcode">
                                                <label for="billing_postcode" class="">Security Code&nbsp;<span class="optional">(optional)</span></label><span class="woocommerce-input-wrapper"><input class="input-text " name="billing_postcode" id="billing_postcode" placeholder="SecurityCode" value="" autocomplete="postal-code" type="text"></span></p>
                            ...
                            <div id="order_review" class="woocommerce-checkout-review-order">
                                <table class="shop_table woocommerce-checkout-review-order-table" style="position: relative;">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="cart-subtotal">
                                            <th>Quantity</th>
                                            <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&nbsp;</span>2</span>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- <tr class="shipping">
                                            ...
                                            <td data-title="Shipping">
                                                Flat rate: <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$&nbsp;</span>20.00</span>
                                                <input name="shipping_method[0]" data-index="0" id="shipping_method_0" value="flat_rate:1" class="shipping_method" type="hidden">
                                        ...
                                        <tr class="order-total">
                                            <th>Total</th>
                                            <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$&nbsp;</span>420.00</span></strong> </td>
                                        </tr>
                                ...
                                <div id="payment" class="woocommerce-checkout-payment">
                                    ...
                                    <div class="form-row place-order">
                                        ...
                                        <button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Place order" data-value="Place order">Continue to payment</button>
