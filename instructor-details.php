...
<head>
    ...
    <title>Educature-Instructor details</title>
                    ...
                    <div class="col-md-8 pl-4">
                        <div class="course-single-details">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <!-- <a class="nav-item nav-link active" id="nav-2" data-toggle="tab" href="#curriculum" role="tab" aria-controls="curriculum" aria-selected="false">Curriculum</a> -->
                ...
                <div class="course-items">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb">
                                    <a href="course-details.php"><img src="images/popular/13.jpg" alt="Item Thumbnail"></a>
                                </div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="course-details.php">Character Art School: Complete Character Drawing</a></h3>
                                    <!-- /.item-title -->
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb">
                                    <a href="course-details.php"><img src="images/popular/14.jpg" alt="Item Thumbnail"></a>
                                </div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="course-details.php">The Ultimate Drawing Course - Beginner to Advanced</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="instructor-details.php">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb">
                                    <a href="course-details.php"><img src="images/popular/15.jpg" alt="Item Thumbnail"></a>
                                </div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="course-details.php">Arts Therapy - Arts Therapy For Self Healing (Part One)</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="instructor-details.php">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="item-thumb">
                                    <a href="course-details.php"><img src="images/popular/16.jpg" alt="Item Thumbnail"></a>
                                </div>
                                <!-- /.item-thumb -->
                                <div class="item-details">
                                    <h3 class="item-title"><a href="course-details.php">Discover How to Draw and paint Comics</a></h3>
                                    <!-- /.item-title -->
                                    <span class="instructor"><a href="instructor-details.php">Justin Marks</a></span>
                                    <!-- /.instructor -->
                                    <div class="details-bottom">
