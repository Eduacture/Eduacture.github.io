                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="event-single-contents">
                            <div class="event-banner background-bg text-center" data-image-src="images/posts/6.jpg">
                                <div class="overlay">
                                    <div id="countdown"></div>
                                </div><!-- /.overlay -->
                            </div><!-- /.event-banner -->

                            <h2 class="event-title">Advice from a Successful Venture Capitalist</h2><!-- /.event-title -->
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/1.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/2.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/3.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/4.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/5.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/6.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/7.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="speaker">
                                        <div class="avatar radius"><img src="images/speakers/8.jpg" alt="Avatar Image"></div><!-- /.avatar -->
                                        <div class="speaker-details">
                    ...
                    <div class="col-md-4">
                        <aside class="sidebar">
                            <button class="btn btn-lg enroll-btn">Join the event</button>
                            ...
                            <div class="widget widget_event_meta">
                                ...
                                <div class="meta-info">
                                    <ul class="info-list">
                                        ...
                                        <li><span class="meta-id">Date</span> Aug 20- Aug 22</li>
                                        <li><span class="meta-id">Time</span> 11.00am - 04.30.00pm</li>
                                        <li><span class="meta-id">Place</span> Paris, France</li>
                                        <li><span class="meta-id">Total Seats</span> 250</li>
                                        <li>
