...
<body>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="top-contact">
                            <span><i class="fas fa-phone"></i> <a href="tel:61383766284">(+61) 38376 6284</a></span>
                            <span><i class="fas fa-envelope"></i> <a href="#">support@courseware.com</a></span>
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    <section class="banner-section banner-03 background-bg" data-image-src="images/banner/3.jpg">
        <div class="overlay">
                ...
                <div class="container">
                    <div class="banner-texts text-center">
                        ...
                        <div class="row mt-5 pt-4">
                            <div class="col-md-4">
                                <div class="item bg-">
                                    <h4 class="item-title">Fresh Content</h4><!-- /.item-title -->
                                    <p>
                            ...
                            <div class="col-md-4">
                                <div class="item bg-">
                                    <h4 class="item-title">Trusted Instructors</h4><!-- /.item-title -->
                                    <p>
                                        Raising a heavy fur muff, covered the whole lower arm towards the viewer
                                    </p>
                                </div><!-- /.item -->
                            </div>
                            <div class="col-md-4">
                                <div class="item bg-">
                                    <h4 class="item-title">Flexible Learning</h4><!-- /.item-title -->
                                    <p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="item-icon mb-3"><i class="icons icon-chart"></i></div><!-- /.item-icon -->
                            <div class="item-details">
                                <h4 class="item-title">Business</h4><!-- /.item-title -->
                                <p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="item-icon mb-3"><i class="icons icon-screen-desktop"></i></div><!-- /.item-icon -->
                            <div class="item-details">
                                <h4 class="item-title">Computer & IT</h4><!-- /.item-title -->
                                <p>
                                    He threw himself onto his right and rolled back to where he was. He must have tried it hundred times, shut his eyes so that wouldn’t have to look
                                </p>
                            </div><!-- /.item-details -->
                        </div><!-- /.item -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="item-icon mb-3"><i class="icons icon-rocket"></i></div><!-- /.item-icon -->
                            <div class="item-details">
                                <h4 class="item-title">Science</h4><!-- /.item-title -->
                                <p>
                                    At the floundering legs, he looks and only stopped when he began to feel a mild, dull pain there that he had never felt before.
                                </p>
                            </div><!-- /.item-details -->
                        </div><!-- /.item -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="item-icon mb-3"><i class="icons icon-music-tone-alt"></i></div><!-- /.item-icon -->
                            <div class="item-details">
                                <h4 class="item-title">Music</h4><!-- /.item-title -->
                                <p>
                                    Doing business like this takes much more effort than doing your own business at home, and on top of that there’s the curse of travelling
                                </p>
                            </div><!-- /.item-details -->
                        </div><!-- /.item -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="item-icon mb-3"><i class="icons icon-picture"></i></div><!-- /.item-icon -->
                            <div class="item-details">
                                <h4 class="item-title">Photography</h4><!-- /.item-title -->
                                <p>
                                    He worries about making train connections and irregular food, contact with different people all the time so that you or anyone become friendly.
                                </p>
                            </div><!-- /.item-details -->
                        </div><!-- /.item -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            <div class="item-icon mb-3"><i class="icons icon-cup"></i></div><!-- /.item-icon -->
                            <div class="item-details">
                                <h4 class="item-title">Culinary</h4><!-- /.item-title -->
                                <p>
                                    It can all go to Hell. He felt a slight itch up on his belly, pushed himself up on his back towards the headboard so that he lift his head better
                                </p>
                            </div><!-- /.item-details -->
                        </div><!-- /.item -->
                    </div>
    ...
    <section class="popular-courses gray-bg">
        <div class="section-padding">
            <div class="container">
                <div class="top-content">
                    ...
                    <div class="owl-controls float-right"></div><!-- /.owl-controls -->
                </div><!-- /.top-content -->
                    ...
                    <div id="course-slider" class="course-slider owl-carousel">
                        <div class="item">
                            <div class="item-thumb">
                                ...
                                <div class="avatar"><img class="rounded-circle" src="images/avatar/1.png" alt="Avatar Image"></div><!-- /.avatar -->
                            </div><!-- /.item-thumb -->
                            <div class="item-details">
                                <h3 class="item-title"><a href="#">Python Bootcamp: Go from zero to hero in Python</a></h3><!-- /.item-title -->
                                ...
                                <div class="item-meta">
                                    <span><i class="icons icon-people"></i> 129</span>
                                    <span><i class="icons icon-clock"></i> 22Hrs</span>
                                    <span><i class="icons icon-bubble"></i> 51</span>
                                </div><!-- /.item-meta -->
                            </div><!-- /.item-details -->
                        </div><!-- /.item -->
                        ...
                        <div class="item">
                            <div class="item-thumb">
                                ...
                                <div class="avatar"><img class="rounded-circle" src="images/avatar/2.png" alt="Avatar Image"></div><!-- /.avatar -->
                            </div><!-- /.item-thumb -->
                            <div class="item-details">
                                <h3 class="item-title"><a href="#">The Complete Web Developer Bootcamp</a></h3><!-- /.item-title -->
                                <span class="instructor"><a href="#">Justin Marks</a></span><!-- /.instructor -->
                                <div class="details-bottom">
                                    <div class="course-price float-left"><span class="currency">$</span><span class="price">15.99</span></div><!-- /.course-price -->
                                    <div class="rating float-right">
                        ...
                        <div class="item">
                            <div class="item-thumb">
                                ...
                                <div class="avatar"><img class="rounded-circle" src="images/avatar/3.png" alt="Avatar Image"></div><!-- /.avatar -->
                            </div><!-- /.item-thumb -->
                            <div class="item-details">
                                <h3 class="item-title"><a href="#">Complete Web Developer in 2018: Zero to Mastery</a></h3><!-- /.item-title -->
                                <span class="instructor"><a href="#">Justin Marks</a></span><!-- /.instructor -->
                                <div class="details-bottom">
                                    <div class="course-price float-left"><span class="currency">$</span><span class="price">15.99</span></div><!-- /.course-price -->
                                    <div class="rating float-right">
                        ...
                        <div class="item">
                            <div class="item-thumb">
                                ...
                                <div class="avatar"><img class="rounded-circle" src="images/avatar/4.png" alt="Avatar Image"></div><!-- /.avatar -->
                            </div><!-- /.item-thumb -->
                            <div class="item-details">
                                <h3 class="item-title"><a href="#">Course On: Complete Java Masterclass</a></h3><!-- /.item-title -->
                                <span class="instructor"><a href="#">Justin Marks</a></span><!-- /.instructor -->
                                <div class="details-bottom">
                                    <div class="course-price float-left"><span class="currency">$</span><span class="price">15.99</span></div><!-- /.course-price -->
                                    <div class="rating float-right">
                        ...
                        <div class="item">
                            ...
                            <div class="item-details">
                                <h3 class="item-title"><a href="#">Complete JavaScript Course 2018: Build Real Projects!</a></h3><!-- /.item-title -->
                                <span class="instructor"><a href="#">Justin Marks</a></span><!-- /.instructor -->
                                <div class="details-bottom">
                                    <div class="course-price float-left"><span class="currency">$</span><span class="price">15.99</span></div><!-- /.course-price -->
                                    <div class="rating float-right">
    ...
    <section class="top-courses">
        <div class="section-padding">
            <div class="container">
                ...
                <div class="row mt-2">
                    <div class="col-md-4 bm30">
                        <div class="item radius">
                            <div class="item-thumb">
                                <img src="images/top/1.jpg" alt="Item Thumb">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-6">
                                <div class="item radius">
                                    <div class="item-thumb">
                                        <img src="images/top/2.jpg" alt="Item Thumb">
                                        <div class="overlay"></div><!-- /.overlay -->
                                    </div>
                                    <div class="item-details">
                            ...
                            <div class="col-6">
                                <div class="item radius">
                                    <div class="item-thumb">
                                        <img src="images/top/3.jpg" alt="Item Thumb">
                                        <div class="overlay"></div><!-- /.overlay -->
                                    </div>
                                    <div class="item-details">
                            ...
                            <div class="col-12">
                                <div class="item radius">
                                    <div class="item-thumb">
                                        <img src="images/top/4.jpg" alt="Item Thumb">
                                        <div class="overlay"></div><!-- /.overlay -->
                                    </div>
                                    <div class="item-details">
    ...
    <section class="testimonial text-center gray-bg">
        <div class="section-padding">
            <div class="container">
                <div id="testimonial-slider" class="testimonial-slider carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="media">
                                <img class="rounded-circle mr-3" src="images/avatar/5.png" alt="Avatar Image">
                        ...
                        <div class="carousel-item">
                            <div class="media">
                                <img class="rounded-circle mr-3" src="images/avatar/6.png" alt="Avatar Image">
                                <div class="media-body">
                        ...
                        <div class="carousel-item">
                            <div class="media">
                                <img class="rounded-circle mr-3" src="images/avatar/7.png" alt="Avatar Image">
                                <div class="media-body">
    ...
    <section class="announcement background-bg text-center" data-image-src="images/bg1.jpg">
        <div class="overlay">
            <div class="section-padding">
                <div class="container">
                    <div class="announcement-content">
                        <h3 class="title">Sign up & get <span>65%</span> off</h3>
                        <h2>on New Courses Starts in May</h2>

                        <div class="btn-container mt-2 text-center">
