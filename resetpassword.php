...
<head>
    ...
    <title>Educature-Reset Password</title>
            ...
            <div class="container">
                <div class="contents text-center">
                    ...
                    <form class="sign-in-form" id="sign-in-form" action="#" method="post">
                        <p class="form-input">
                            <input type="text" name="forgot" id="forgot_password" class="input" value="" placeholder="Email" required="">
                        </p>
                        <p class="form-input">
                            <input type="text" name="forgot" id="forgot_password" class="input" value="" placeholder="New Password" required="">
                        </p>
                        <p class="form-input">
                            <input type="text" name="forgot" id="forgot_password" class="input" value="" placeholder="Confirm Password" required="">
                        </p>
                        <p class="form-input">
                            <input type="submit" name="wp-submit" id="wp-submit" class="btn" value="Reset">
                        </p>
