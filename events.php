                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="event media">
                            ...
                            <div class="event-details media-body">
                                <div class="event-thumb radius"><img src="images/event/3.jpg" alt="Event Thumbnail"></div><!-- /.enent-thumb -->
                                <h2 class="event-title"><a href="event-details.php">Your guide to event planning</a></h2><!-- /.event-title -->
                    ...
                    <div class="col-md-6">
                        <div class="event media">
                            ...
                            <div class="event-details media-body">
                                <div class="event-thumb radius"><img src="images/event/4.jpg" alt="Event Thumbnail"></div><!-- /.enent-thumb -->
                                <h2 class="event-title"><a href="event-details.php">Selling Sponsorships for Events & Nonprofits</a></h2><!-- /.event-title -->
                                <div class="event-meta">
                                    <span class="time"><i class="icon-clock"></i> 4am - 8pm</span><!-- /.time -->
                                    <span class="place"><i class="icon-location-pin"></i> New York, USA</span><!-- /.place -->
                                </div><!-- /.event-meta -->
                    ...
                    <div class="col-md-6">
                        <div class="event media">
                            ...
                            <div class="event-details media-body">
                                <div class="event-thumb radius"><img src="images/event/5.jpg" alt="Event Thumbnail"></div><!-- /.enent-thumb -->
                                <h2 class="event-title"><a href="event-details.php">IAS 10 - Events After Reporting Date</a></h2><!-- /.event-title -->
                                <div class="event-meta">
                                    <span class="time"><i class="icon-clock"></i> 4am - 8pm</span><!-- /.time -->
                                    <span class="place"><i class="icon-location-pin"></i> New York, USA</span><!-- /.place -->
                                </div><!-- /.event-meta -->
                    ...
                    <div class="col-md-6">
                        <div class="event media">
                            ...
                            <div class="event-details media-body">
                                <div class="event-thumb radius"><img src="images/event/6.jpg" alt="Event Thumbnail"></div><!-- /.enent-thumb -->
                                <h2 class="event-title"><a href="event-details.php">Advice from a Successful Venture Capitalist</a></h2><!-- /.event-title -->
                                <div class="event-meta">
                                    <span class="time"><i class="icon-clock"></i> 4am - 8pm</span><!-- /.time -->
                                    <span class="place"><i class="icon-location-pin"></i> New York, USA</span><!-- /.place -->
                                </div><!-- /.event-meta -->
                    ...
                    <div class="col-md-6">
                        <div class="event media">
                            ...
                            <div class="event-details media-body">
                                <div class="event-thumb radius"><img src="images/event/7.jpg" alt="Event Thumbnail"></div><!-- /.enent-thumb -->
                                <h2 class="event-title"><a href="event-details.php">Fundraising Success: The Complete Development Plan</a></h2><!-- /.event-title -->
                                <div class="event-meta">
                                    <span class="time"><i class="icon-clock"></i> 4am - 8pm</span><!-- /.time -->
                                    <span class="place"><i class="icon-location-pin"></i> New York, USA</span><!-- /.place -->
                                </div><!-- /.event-meta -->
                    ...
                    <div class="col-md-6">
                        <div class="event media">
                            ...
                            <div class="event-details media-body">
                                <div class="event-thumb radius"><img src="images/event/8.jpg" alt="Event Thumbnail"></div><!-- /.enent-thumb -->
                                <h2 class="event-title"><a href="event-details.php">LIVE Streaming Pro: Ultimate Course | From Beginner to Pro</a></h2><!-- /.event-title -->
                                <div class="event-meta">
                                    <span class="time"><i class="icon-clock"></i> 4am - 8pm</span><!-- /.time -->
                                    <span class="place"><i class="icon-location-pin"></i> New York, USA</span><!-- /.place -->
                                </div><!-- /.event-meta -->
