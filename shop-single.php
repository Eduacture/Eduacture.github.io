                ...
                <div class="row">
                        ...
                        <div class="single-item-contents">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="item-1" role="tabpanel" aria-labelledby="nav-1">
                                                <img class="radius" src="images/shop/single.jpg" alt="item Image">
                                            </div>
                                            <div class="tab-pane fade" id="item-2" role="tabpanel" aria-labelledby="nav-2">
                                                <img class="radius" src="images/shop/single2.jpg" alt="item Image">
                                            </div>
                                            <div class="tab-pane fade" id="item-3" role="tabpanel" aria-labelledby="nav-3">
                                                <img class="radius" src="images/shop/single3.jpg" alt="item Image">
                                            </div>
                                        </div>

                                        <div class="nav nav-tabs" id="nav-tab-1" role="tablist">
                                            <a class="nav-item nav-link active" id="nav-1" data-toggle="tab" href="#item-1" role="tab" aria-controls="item-1" aria-selected="true">
                                                <img class="radius" src="images/shop/st1.jpg" alt="Item Thumb">
                                            </a>
                                            <a class="nav-item nav-link" id="nav-2" data-toggle="tab" href="#item-2" role="tab" aria-controls="item-2" aria-selected="false">
                                                <img class="radius" src="images/shop/st2.jpg" alt="Item Thumb">
                                            </a>
                                            <a class="nav-item nav-link" id="nav-3" data-toggle="tab" href="#item-3" role="tab" aria-controls="item-3" aria-selected="false">
                                                <img class="radius" src="images/shop/st3.jpg" alt="Item Thumb">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <button class="btn btn-lg cart-btn float-left">Add to cart</button>
                            ...
                            <div class="single-item-details">
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-4" data-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true">Description</a>
                                    <a class="nav-item nav-link" id="nav-5" data-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">Reviews</a>
                                </div>
                                                ...
                                                <ol class="review-list">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="review-details">
                                                                    <h3 class="title">Awesome Product with service</h3><!-- /.title -->
                                                                    <div class="rating">
                                                    ...
                                                    <li class="review">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="review-details">
                                                                    <h3 class="title">Satisfied with Product and service</h3><!-- /.title -->
                                                                    <div class="rating">
                                                                        <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="5" data-fractions="5" />
                                                                    </div><!-- /.rating -->
                                                                    <p>
                                                    ...
                                                    <li class="review">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="review-details">
                                                                    <h3 class="title">Wanna buy more</h3><!-- /.title -->
                                                                    <div class="rating">
                                                                        <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="5" data-fractions="5" />
                                                                    </div><!-- /.rating -->
                                                                    <p>
                            ...
                            </div><!-- /.single-item-details -->
                        </div><!-- /.single-item-contents -->
                            ...
                            <div class="shop-items text-center">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="item">
                                            <div class="item-image">
                                                <img src="images/shop/1.jpg" alt="Item Image" class="radius">
                                                <div class="item-hover">
                                                    <a href="shop-single.php" class="btn">View details</a>
                                                    <div class="rating">
                                                        <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                                    </div><!-- /.rating -->
                                                </div><!-- /.item-hover -->
                                            ...
                                            <div class="item-details">
                                                <h3 class="item-title"><a href="shop-single.php">Product Name</a></h3><!-- /.item-title -->
                                                <div class="price">
                                                    <span class="current-price">$15.99</span><!-- /.current-price -->
                                                </div><!-- /.price -->
                                                <p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="item">
                                            <div class="item-image">
                                                <img src="images/shop/2.jpg" alt="Item Image" class="radius">
                                                <div class="item-hover">
                                                    <a href="shop-single.php" class="btn">View details</a>
                                                    <div class="rating">
                                                        <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="item">
                                            <div class="item-image">
                                                <img src="images/shop/3.jpg" alt="Item Image" class="radius">
                                                <div class="item-hover">
                                                    <a href="shop-single.php" class="btn">View details</a>
                                                    <div class="rating">
                                                        <input type="hidden" class="rating-tooltip-manual" data-filled="fas fa-star" data-empty="far fa-star" value="4.5" data-fractions="5" />
                    ...
                    <div class="col-md-4">
                        <aside class="sidebar">
                            ...
                            <div class="widget widget_popular_items">
                                <h2 class="widget-title">Popular Items</h2>
                                <div class="widget-details">
                                    <div class="item media">
                                        <div class="item-thumbnail">
                                        ...
                                        <div class="item-details media-body">
                                            <h3 class="item-title"><a href="#">Product Title</a></h3>
                                            <div class="price"><span class="current-price">$15.00</span></div><!-- /.price -->
                                        </div>
                            ...
                            <div class="widget widget_filter_price">
                                <h3 class="widget-title">Price</h3><!-- /.widget-title -->
                                <div class="widget-details">
                                    ...
                                    <button class="btn float-right filter-btn">Filter</button>
                                </div><!-- /.widget-details -->
                            </div><!-- /.widget -->

                            <div class="widget widget_filter_color">
                                <h3 class="widget-title">Color</h3><!-- /.widget-title -->
                                <div class="widget-details">
                            ...
                            <div class="widget widget_reset">
                                <button class="btn btn-lg reset-btn">Reset</button>
                            </div><!-- /.widget -->
                        </aside>
                    </div>
                </div><!-- /.row -->
        ...
        <div class="footer-bottom black-bg">
            <div class="section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <duv class="copy-right float-left">
